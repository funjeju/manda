    ...
    <div className="p-8 max-w-7xl mx-auto w-full relative">
      <header className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-zinc-400">Manage your goals and tasks with Mandalart structure.</p>
        </div>
        <Link
          href="/projects/new"
          className="flex items-center gap-2 bg-orange-600 hover:bg-orange-500 text-white px-4 py-2 rounded-md font-medium transition"
        >
          <Plus size={18} />
          New Project
        </Link>
